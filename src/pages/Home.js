...
const Home = () => {
  ...
  const headingText = "Experience Luxury at Diamond Salon"
  const headingLetters = headingText.split("")

  // Animation variants for letters with continuous loop
  const letterVariants = {
    ...
    animate: (i) => ({
      ...
      transition: {
        ...
        duration: 0.3,
        repeat: Number.POSITIVE_INFINITY, // Make the animation repeat infinitely
        repeatDelay: 5, // Wait 5 seconds before repeating the entire animation
        repeatType: "reverse", // Reverse the animation when repeating for a nice effect
      },
    }),
  }
